...
"$SCRIPT" create task "cross-test" --title="Cross Tool Test" --status=active --project=nazar --tags=nix,devops
...
[ "$project_val" = "nazar" ] || fail "expected project=nazar, got '$project_val'"
